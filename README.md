...
Note that when more AWS services described in the [blog](https://unit42.paloaltonetworks.com/aws-resource-based-policy-apis/) are integrated, the permissions policy will be updated.
